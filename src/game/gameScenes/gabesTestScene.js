...
class GabeScene extends Phaser.Scene {
	...
	create() {
		...
		//garage
		this.garage1 = createGarage(this, [1150, 750], [3, 0.25], "RIGHT", 0.03);
		this.garage2 = createGarage(this, [500, 350], [0.25, 3], "UP", 0.01);
		this.garage3 = createGarage(this, [1150, 350], [0.25, 3], "DOWN", 0.02);
